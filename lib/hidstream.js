...
const every = require('underscore/modules/every.js');
const isUndefined = require('underscore/modules/isUndefined.js');
...
function verify(options) {
  if (every([options.path,  options.vendorId, options.productId], isUndefined)) {
